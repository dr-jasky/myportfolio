...
import { CitationsPage } from './pages/CitationsPage'; // Added CitationsPage
    ...
    <header className="bg-dark-secondary/80 backdrop-blur-md text-light-primary shadow-lg sticky top-0 z-50 border-b border-neon-blue/20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          <RouterNavLink 
            to="/" 
            className="group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neon-blue focus-visible:ring-offset-2 focus-visible:ring-offset-dark-secondary rounded-md"
          >
            ...
            {navLinksData.map((link: NavLinkType) => (
              <RouterNavLink
                ...
                className={({ isActive }) =>
                  ...
                  } focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neon-blue focus-visible:ring-offset-2 focus-visible:ring-offset-dark-secondary`
                }
              >
                {link.name}
              </RouterNavLink>
          ...
          <div className="md:hidden">
            <button
              ...
              className="text-light-secondary hover:text-neon-blue focus:outline-none p-2 rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neon-blue focus-visible:ring-offset-2 focus-visible:ring-offset-dark-secondary"
      ...
      <div className="flex justify-center space-x-5 sm:space-x-8 mb-8">
        {contactLinksData.map(link => (
          <a
            ...
            className="text-light-secondary hover:text-neon-blue transition-all duration-300 text-3xl sm:text-4xl transform hover:scale-125 hover:animate-pulseGlow [--tw-shadow-color:theme('colors.neon-blue')] focus-visible:outline-none focus-visible:rounded-md focus-visible:ring-2 focus-visible:ring-neon-blue focus-visible:ring-offset-2 focus-visible:ring-offset-dark-secondary"
...
const ScrollToTopButton: React.FC = () => {
  ...
  return (
    <button
      type="button"
      onClick={scrollToTop}
      className={`scroll-to-top ${isVisible ? 'visible' : ''} focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neon-pink focus-visible:ring-offset-2 focus-visible:ring-offset-dark-primary`}
      ...
      <div className="flex flex-col min-h-screen">
        ...
        <main className="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
          <Routes>
            ...
            <Route path="/citations" element={<CitationsPage />} /> {/* Added Citations route */}
          </Routes>
        </main>
        <Footer />
        <ScrollToTopButton />
